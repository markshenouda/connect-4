        ...
        for(let y = 0; y < winningArrays.length; y++) {
            ...
            if(square1.classList.contains('player-one') &&
                ...
                square4.classList.contains('player-one')) {
                    ...
                    square1.classList.add('player-one-winner')
                    square2.classList.add('player-one-winner')
                    square3.classList.add('player-one-winner')
                    square4.classList.add('player-one-winner')
            ...
            //now check to see if they all have the classname player two
                ...
                square4.classList.contains('player-two')) {
                    ...
                    square1.classList.add('player-two-winner')
                    square2.classList.add('player-two-winner')
                    square3.classList.add('player-two-winner')
                    square4.classList.add('player-two-winner')
